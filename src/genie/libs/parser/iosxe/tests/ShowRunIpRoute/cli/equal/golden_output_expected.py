expected_output = {'ip_routes': {
    ...
    6: {'vrf': '', 'vrf_global': '', 'subnet': '139.156.202.96',
        'subnet_mask': '255.255.255.240', 'next_hop': 'GigabitEthernet0/1/1',
        'forward_address': '', 'route_name': '', 'metric': '',
        'track_object': '', 'permanent': '', 'tag': '',
        'parsing_leftovers': ''},
    ...
    13: {'vrf': '', 'vrf_global': '', 'subnet': '139.156.202.96',
         'subnet_mask': '255.255.255.240', 'next_hop': 'Vlan100',
         'forward_address': '10.194.48.110', 'route_name': '', 'metric': '255',
         'track_object': '', 'permanent': '', 'tag': '',
         'parsing_leftovers': ''},
    ...
    23: {'vrf': '', 'vrf_global': '', 'subnet': '60.250.233.50',
         'subnet_mask': '255.255.255.255', 'next_hop': 'GigabitEthernet0/0',
    ...
    25: {'vrf': '', 'vrf_global': '', 'subnet': '139.156.202.96',
         ...
         'track_object': '100', 'permanent': '', 'tag': '',
         'parsing_leftovers': ''},
    26: {'vrf': 'infinity01', 'vrf_global': 'global', 'subnet': '10.100.0.0',
