expected_output = {
    ...
    'hatseflats-2': {'networks': {
        ...
        'netbios_servers': [
            '10.1.1.101',
            '10.1.1.102']},
    'BFR-Venlo-voice': {'networks': {
        1: {'ip': '172.19.0.0', 'subnet_mask': '255.255.0.0',
            'secondary': False}}, 'dhcp_options': {
        1: {'option': '43', 'type': 'hex',
            'data': '010a.5369.656d.656e.7300.0000.0204.0000'}},
        'dhcp_excludes': {},
        'domain': 'venlo-voice.local',
        'gateway': '172.19.0.254',
        'dns_servers': ['10.31.1.1', '10.31.107.253']},
    'CONTENTGURU-(CGR)': {'networks': {
        ...
        'gateway': '10.111.10.1'}, 'DHCP_Amsterdam_RAI': {'networks': {
        ...
        'networks': {1: {'ip': '172.16.100.0', 'subnet_mask': '255.255.255.0',
            ...
            1: {'option': '43', 'type': 'ascii',
                'data': 'id:ipphone.mitel.com;call_srv=145.54.138.146;vlan=40;l2p=6;dscp=46;sw_tftp'}},
